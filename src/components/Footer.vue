  ...
  <footer class="site-footer">
    <div class="content-wrapper">
      <div class="footer-logo">
        <img
          src="/logo-white.webp"
          alt="MRT Energia Solar"
        />
      </div>
      <div class="copyright-text">
        &copy; {{ currentYear }} MRT Engenharia e Energia Solar. Todos os direitos reservados.
      </div>
...
const whatsappNumber = ref('+553100000000')
...
const socials = {
  instagram: { name: 'Instagram', link: 'https://www.instagram.com/mrtsolar.congonhas/', icon: icons.instagram },
}
